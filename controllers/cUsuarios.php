   ...
   require_once __DIR__ . "/../models/mUsuarios.php";
    ...
    class CUsuarios extends Conexion{
        ...
        public function inscripcionUsuarios(){
            ...
            var_dump($_POST);
            if(!empty($_POST["nombreUsuario"]) && !empty($_POST["nombreApellidos"]) && !empty($_POST["password"]) && !empty($_POST["email"]) && !empty($_POST["telefono"]) && isset($_POST["deportes"]) && isset($_POST["condiciones"])){
